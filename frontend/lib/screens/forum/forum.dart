                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      topLevelMessage.userName.length > 20
                                                        ? '${topLevelMessage.userName.substring(0, min(20, topLevelMessage.userName.length))}...'
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      childMessage.userName.length > 20
                                                        ? '${childMessage.userName.substring(0, min(20, childMessage.userName.length))}...'
